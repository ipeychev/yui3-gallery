...
YUI().use( 'dd-delegate', 'gallery-undo', function( Y ){
    ...
    Y.extend( Puzzle, Y.Base, {
        ...
        _onActionAdded : function( attrs ){
            var options, option, action;
        ...
        _onActionCanceled : function( attrs ){
            this._actionView.remove( attrs.index + 1 );
        },
